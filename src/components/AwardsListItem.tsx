  ...
  const animation = prefersReducedMotion
	...
	return (
		<Box
			...
			position="relative"
			height={{ base: '288px', lg: '304px' }}
		>
			<Flex direction="column" alignItems="center" h="100%" justifyContent="space-between">
				<Box textAlign="center">
					...
					<Flex direction="column" w="100%" gap="8px">
						...
						{badge.receivingDate && (
							<Text textAlign="center" color="rgba(255, 255, 255, 0.6)" size="body14/20">
								{badge.receivingDate}
							</Text>
						)}
					</Flex>
