...
import { Box, Grid, SlideFade, Text, useBreakpointValue } from '@chakra-ui/react';
			...
			>
				...
				>
					...
					>
						...
						<Grid justifyContent="end" alignContent="center" onClick={handleClose} cursor="pointer">
							<CloseIcon width="24px" />
						</Grid>
					</Grid>
					<Box overflowY="auto" sx={scrollbarCSS}>
						{content}
					</Box>
				</Box>
			</SlideFade>
