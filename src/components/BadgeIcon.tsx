...
import { ReactComponent as AnchorGold } from "../assets/icons/anchor-gold.svg";
import { ReactComponent as AnchorSilver } from "../assets/icons/anchor-silver.svg";
import { ReactComponent as AnchorBronze } from "../assets/icons/anchor-bronze.svg";

interface Props extends IconProps {
  imageId: Badge;
  isActive?: boolean;
}
export const BadgeIcon: FC<Props> = ({
  imageId,
  isActive = true,
  ...props
}) => {
  const Icon = useMemo(() => {
    ...
    if (imageId === Badge.ConditionalsChampionFirst)
      return ConditionalsChampionFirst;
    if (imageId === Badge.ConditionalsChampionSecond)
      return ConditionalsChampionSecond;
    if (imageId === Badge.ConditionalsChampionThird)
      return ConditionalsChampionThird;
    ...
    if (imageId === Badge.AnchorGold) return AnchorGold;
    if (imageId === Badge.AnchorSilver) return AnchorSilver;
    if (imageId === Badge.AnchorBronze) return AnchorBronze;
