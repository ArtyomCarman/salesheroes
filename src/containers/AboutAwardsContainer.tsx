  ...
  return (
    ...
    >
      <Flex direction="column" gap="16px" position="relative" zIndex="1">
        ...
        >
          <Text>
            В качестве наград в нашем проекте используются бейджи –
            индивидуальные почетные знаки, которые присваиваются вам
            автоматически при соблюдении условий получения.
          </Text>
          ...
          <Text>
            ...
            . Выдаются за единоразовое знаковое событие. Например, вы выдали
            кредит размером более 100 млн рублей. Как только в учетной системе
            появляются данные о выдаче кредита с такой суммой, сразу
            присуждается бейдж.
          </Text>
          <Text>
            <Box as="span" fontWeight="600" color="rgba(255, 191, 62, 1)">
            ...
            . Выдаются за достижение цели в накоплении. Например, для получения
            бейджа вам необходимо закрыть 500 условных сделок за период. У
            такого вида бейджа предусмотрена шкала, которая позволит отследить,
            сколько сделок уже закрыто и сколько осталось для того, чтобы значок
            был присвоен.
          </Text>
          <Text>
            <Box as="span" fontWeight="600" color="rgba(255, 191, 62, 1)">
