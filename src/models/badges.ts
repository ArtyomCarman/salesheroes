...
export const badgeID = [{
    ...
    },
    {
        ...
        specification: {
            description: "Стань одним из лучших в турнире \"Марафон по условным сделкам\" на уровне своего тербанка.",
            features: [
                {
                    number: 1,
                    feature: ""
    ...
    },
    {
        ...
        specification: {
            description: "Победи в турнире \"Марафон по условным сделкам\" в рамках своего ГОСБ \\ Управления",
            features: [
                {
                    number: 1,
                    feature: ""
