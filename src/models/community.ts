      ...
      news: [
        {
          ...
          date: "27.07.26",
          tournamentId: "",
          newsText: `<h3>Игровые механики и соревновательность сотрудников позволила Сберу зарабатать 10 млрд дополнительного дохода в год</h3>

          <p>Компания отчиталась о доходах и зафиксировала подтвержденный эффект от внедрения игровых механик в бизнес-процесс.
