...
import {
    AboutPage, AwardsIdPage, AwardsListPage, AwardsPage, AwardTournamentsPage,
    CommunityIdPage,
    CommunityPage,
    ProfileAllAwardsPage,
    ProfilePage,
    RatingListPage, TournamentIdArchivePage, TournamentsArchivePage, TournamentsIdPage, TournamentsLeadersPage,
    TournamentsPage
} from "./pages";
